package com.example.dwiseptianquiz1;
...
public class MainActivity2 extends AppCompatActivity {
    ...
    public void tampilan(){
        ...
        selamat.setText("Selamar Datang "+nama1.toString());
        tipe_member2.setText("Tipe Member :"+tipe_member1.toString());
        kode_bar2.setText("Kode Barang : "+kode1.toString());
        nama_bar2.setText("Nama Barang : "+nama_barang1.toString());
        harga2.setText("Harga : "+harga1.toString());
        total_harga2.setText("Total Harga :" +total_harga1.toString());
        discount_bar2.setText("Discount Harga :" +diskon_harga1.toString());
        discount_mem2.setText("Discount Member : "+diskon_member1.toString());
        jumlah_harga2.setText("Jumlah Bayar ;" +jumlah1.toString());
